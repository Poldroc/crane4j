...
public @interface AssembleDb {
    ...
    /**
     * Columns to query, if it is empty, use "*" by default.
     *
     * @return field names
     */
    ...
    /**
     * Column to be used as the condition.
     *
     * @return field names
     */
    String whereColumn();
